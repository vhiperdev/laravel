...
<head>
    ...
    <title>{{ config('app.name', $settings->site_name??"") }}</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div id="app" class="wrapper">
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{asset($settings->site_logo)}}" alt="AdminLTELogo" height="60" width="60" />
        </div>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link {{ (\Request::route()->getName() == 'customers') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{route('reseller')}}" class="nav-link {{ (\Request::route()->getName() == 'reseller') ? 'active' : '' }}">
                                <i class="fa fa-users nav-icon"></i>
                                <p>{{__('messages.resellers')}}</p>
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="nav-item">
                            <a href="{{route('products')}}" class="nav-link {{ (\Request::route()->getName() == 'products') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link {{ (\Request::route()->getName() == 'subscriptions') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('subscriptions.active')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Active Subscriptions</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('subscriptions.inactive')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Inactive Subscriptions</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('subscriptions.due_this_month')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Due This Month</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('subscriptions.over_due')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Over due</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link {{ (\Request::route()->getName() == 'messaging') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('messaging.template')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('billing.configure')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        @if(Auth()->user()->hasRole('admin'))
                        <li class="nav-item">
                            <a href="#" class="nav-link {{ (\Request::route()->getName() == 'settings') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('servers')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>{{__('messages.server')}}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('applications')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>{{__('messages.application')}}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('devices')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>{{__('messages.device')}}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('customer_referal')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
