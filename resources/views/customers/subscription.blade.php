            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Customer Subscription</li>
                    </ol>
                </div>
            </div>
        </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="{{route('subscription.history', ['id'=>$subscription->id])}}">Subscription Payment History</a>
                                                    <a class="dropdown-item" href="{{route('subscription.edit', ['id'=>$subscription->id])}}">Edit Subscription</a>
                                                    <a class="dropdown-item" href="{{route('subscription.history', ['id'=>$subscription->id])}}">Renew</a>
                                                    <a class="dropdown-item text-danger" href="{{route('customers.destroy', ['id'=>$customer->id])}}" onclick="return confirm('Are you sure you want to delete this subscription?')">Disable/deactivate</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('subscriptions.store', ['id'=> $customer->id]) }}">
