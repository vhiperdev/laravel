                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Customers on this device</th>
                                            <th>Created Time</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$dev->name}}</td>
                                            <td>{{$dev->getCustomerCount()}}</td>
                                            <td>{{$dev->created_at}}</td>
                                            <td>
                                                <button class="btn btn-warning btn-sm edit-button" data-bs-toggle="modal" data-bs-target="#editModal" data-item-id="{{$dev->id}}" data-item-name="{{$dev->name}}">Edit</button>
                                                <a href="{{route('device.customer', ['id'=>$dev->id])}}"><button class="btn btn-secondary btn-sm edit-button">Customers</button></a>
                                            </td>
                                        </tr>
                                        @endforeach
