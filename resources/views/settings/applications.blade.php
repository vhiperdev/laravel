                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$apps->name}}</td>
                                            <td>{{$apps->getCustomerCount()}}</td>
                                            <td>{{$apps->created_at}}</td>
                                            <td>
                                                <button class="btn btn-warning btn-sm edit-button" data-bs-toggle="modal" data-bs-target="#editModal" data-item-id="{{$apps->id}}" data-item-name="{{$apps->name}}">Edit</button>
                                                <a href="{{route('applications.customer', ['id'=>$apps->id])}}"><button class="btn btn-secondary btn-sm edit-button">Customers</button></a>
                                            </td>
                                        </tr>
                                        @endforeach
