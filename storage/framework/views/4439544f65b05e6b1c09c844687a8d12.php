                            ...
                            <div class="container-fluid">
                                ...
                                <div class="card card-default mt-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="<?php echo e(route('customers.update', ['id'=>$customer->id])); ?>">
                                            <?php echo csrf_field(); ?>
                                            <div class="row">
                                                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" value="<?php echo e(old('name')?? $customer->name); ?>" autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" value="<?php echo e(old('username')?? $customer->username); ?>" autocomplete="username" autofocus>
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" value="<?php echo e(old('screen')?? $customer->screen); ?>" autocomplete="screen" autofocus>
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" value="<?php echo e(old('whatsapp')?? $customer->whatsapp); ?>" autocomplete="whatsapp" autofocus>
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" autocomplete="device_id" autofocus>
                                                            ...
                                                            <option value="<?php echo e($dev->id); ?>" <?php if(old('device_id', optional($customer)->device_id)==$dev->id): ?> selected <?php endif; ?>>
                                                                <?php echo e($dev->name); ?>
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" autocomplete="server" autofocus>
                                                            ...
                                                            <option value="<?php echo e($serve->id); ?>" <?php if(old('server', optional($customer)->server)==$serve->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" autocomplete="application_id" autofocus>
                                                            ...
                                                            <option value="<?php echo e($app->id); ?>" <?php if(old('application_id', optional($customer)->application_id)==$app->id): ?> selected <?php endif; ?>>
                                                                <?php echo e($app->name); ?>
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" value="<?php echo e(old('mac')?? $customer->mac); ?>" autocomplete="mac" autofocus>
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" value="<?php echo e(old('key')?? $customer->key); ?>" autocomplete="key" autofocus>
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" value="<?php echo e(old('password')?? $customer->password); ?>" autocomplete="password" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/customers/edit.blade.php ENDPATH**/ ?>