...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo e(__('messages.all_application')); ?></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#"><?php echo e(__('messages.home')); ?></a></li>
                        <li class="breadcrumb-item active"><?php echo e(__('messages.all_application')); ?></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title"><?php echo e(__('messages.applications')); ?></h3>
                                </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo e(__('messages.customer_count')); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($apps->name); ?></td>
                                            <td><?php echo e($apps->getCustomerCount()); ?></td>
                                            <td>
                                                <?php if($apps->user): ?>
                                                <?php echo e($apps->user->name); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td><?php echo e($apps->created_at); ?></td>
                                            <td>
                                                <button class="btn btn-warning btn-sm edit-button" data-bs-toggle="modal" data-bs-target="#editModal" data-item-id="<?php echo e($apps->id); ?>" data-item-name="<?php echo e($apps->name); ?>"><?php echo e(__('messages.edit')); ?></button>
                                                <a href="<?php echo e(route('applications.customer', ['id'=>$apps->id])); ?>"><button class="btn btn-secondary btn-sm edit-button"><?php echo e(__('messages.customers')); ?></button></a>
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('messages.create_new_application')); ?></h5>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('application.update')); ?>" enctype="multipart/form-data">
                    <div class="modal-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/settings/applications.blade.php ENDPATH**/ ?>