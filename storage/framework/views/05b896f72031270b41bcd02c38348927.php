...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?php echo e(__('messages.customer_subscription')); ?></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#"><?php echo e(__('messages.home')); ?></a></li>
                        <li class="breadcrumb-item active"><?php echo e(__('messages.customer_subscription')); ?></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title"><?php echo e(__('messages.subscriptions')); ?></h3>
                                </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="<?php echo e(route('subscription.history', ['id'=>$subscription->id])); ?>">Subscription Payment History</a>
                                                    <a class="dropdown-item" href="<?php echo e(route('subscription.edit', ['id'=>$subscription->id])); ?>">Edit Subscription</a>
                                                    <a class="dropdown-item" href="<?php echo e(route('subscription.history', ['id'=>$subscription->id])); ?>">Renew</a>
                                                    <a class="dropdown-item text-danger" href="<?php echo e(route('customers.destroy', ['id'=>$customer->id])); ?>" onclick="return confirm('Are you sure you want to delete this subscription?')">Disable/deactivate</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('messages.create_new_subscription')); ?> </h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <form method="POST" action="<?php echo e(route('subscriptions.store', ['id'=> $customer->id])); ?>">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label><?php echo e(__('messages.product')); ?></label>
                                                <select name="product" id="product" class="form-control select2  <?php $__errorArgs = ['product'];
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" value="<?php echo e(old('product')); ?>" autocomplete="name" autofocus onchange="fetchPlans()">
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" value="<?php echo e(old('product_plan_id')); ?>" autocomplete="product_plan_id" autofocus>
                                                </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/customers/subscription.blade.php ENDPATH**/ ?>